from ssa._ssa import telegraph_hill
from ode import TelegraphHillODE
...
ode = TelegraphHillODE(k1,k2,k3,k4,K,npow)
...
while n < Nreps:
    ...
    x1, x2, x3, times = telegraph_hill([end_time,k1,k2,k3,k4,Nt,K,npow])
    values = [x1, x2, x3]
    try:
