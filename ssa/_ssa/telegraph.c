...
void update_p(double t, double p[], double k_on, double k_off, double k_syn, double k_deg, int x[]){
...
int telegraph_constant_ssa(int** x1_ptr, int** x2_ptr, int** x3_ptr, double** times_ptr, int* length, 
